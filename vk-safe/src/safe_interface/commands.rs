...
pub trait EnumerateInstanceExtensionProperties {
    ...
    fn enumerate_instance_extension_properties<S: EnumeratorStorage<vk::ExtensionProperties>>(&self, layer_name: Option<&CStr>, storage: S) -> Result<S::InitStorage>;
}

pub trait EnumerateInstanceLayerProperties {
    fn enumerate_instance_layer_properties_len(&self) -> Result<usize>;
    fn enumerate_instance_layer_properties<S: EnumeratorStorage<vk::LayerProperties>>(&self, storage: S) -> Result<S::InitStorage>;
}